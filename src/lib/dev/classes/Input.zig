...
immediate: dev.intr.SoftHandler,

node: INode = .{},

pub inline fn setup(self: *Self, kind: Kind) Error!void {
    return bindings.getInstance().dev.classes.input.setup(self, kind);
}

pub inline fn deinit(self: *Self) void {
    bindings.getInstance().dev.classes.input.deinit(self);
}
...
pub inline fn createHandle(self: *Self, handler: *Event.Handler) Error!*Event.Handle {
    return bindings.getInstance().dev.classes.input.createHandle(self, handler);
}

pub inline fn deleteHandle(self: *Self, handle: *Event.Handle) void {
    bindings.getInstance().dev.classes.input.deleteHandle(self, handle);
}

pub inline fn createListener(self: *Self) Error!*Event.Listener {
    return bindings.getInstance().dev.classes.input.createListener(self);
}

pub inline fn deleteListener(self: *Self, listener: *Event.Listener) void {
    bindings.getInstance().dev.classes.input.deleteListener(self, listener);
}

pub inline fn safeNotifyListeners(self: *Self) void {
    bindings.getInstance().dev.classes.input.safeNotifyListeners(self);
}

pub inline fn notifyListeners(self: *Self) void {
    bindings.getInstance().dev.classes.input.notifyListeners(self);
}

inline fn processEvent(self: *Self, event: Event) void {
    bindings.getInstance().dev.classes.input.processEvent(self, event);
}
